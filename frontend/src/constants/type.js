export const types = {
    ...
    ADMIN_FETCHORDER_REQUEST: 'ADMIN_FETCHORDER_REQUEST',
    ADMIN_FETCHORDER_SUCCESS: 'ADMIN_FETCHORDER_SUCCESS',
    ADMIN_FETCHORDER_ERROR: 'ADMIN_FETCHORDER_ERROR',

    //Admin Update the deliver status
    ADMIN_DELIVER_REQUEST: 'ADMIN_DELIVER_REQUEST',
    ADMIN_DELIVER_SUCCESS: 'ADMIN_DELIVER_SUCCESS',
    ADMIN_DELIVER_ERROR: 'ADMIN_DELIVER_ERROR',
    ADMIN_DELIVER_RESET: 'ADMIN_DELIVER_RESET',

    //Product Review
    PRODUCT_REVIEW_REQUEST: 'PRODUCT_REVIEW_REQUEST',
    PRODUCT_REVIEW_SUCCESS: 'PRODUCT_REVIEW_SUCCESS',
    PRODUCT_REVIEW_ERROR: 'PRODUCT_REVIEW_ERROR',
    PRODUCT_REVIEW_RESET: 'PRODUCT_REVIEW_RESET',

    //Fetch top 3 products
    TOP_PRODUCTS_REQUEST: 'TOP_PRODUCTS_REQUEST',
    TOP_PRODUCTS_SUCCESS: 'TOP_PRODUCTS_SUCCESS',
